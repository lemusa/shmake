...
const headerStyle = { flexShrink: 0, display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 16px', background: 'rgba(10,10,10,0.95)', borderBottom: '1px solid #2a2a2a' }
